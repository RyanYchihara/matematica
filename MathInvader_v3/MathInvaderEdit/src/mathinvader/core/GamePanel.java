...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public enum GameState { MENU, PLAYING, PAUSED, GAMEOVER, AUDIO, RECORDES, VISUAL }
    ...
    private void handleMenuKey(KeyEvent e) {
        ...
        if (code == KeyEvent.VK_DOWN) menuSelection = Math.min(4, menuSelection + 1);
        if (code == KeyEvent.VK_ENTER) {
            ...
            else if (menuSelection == 3) state = GameState.VISUAL;
            else                         System.exit(0);
        }
    }
    ...
    private void drawMenu(Graphics2D g) {
        ...
        String[] options = {"> JOGAR", "* RECORDES", ") AUDIO", "@ VISUAL", "X SAIR"};
